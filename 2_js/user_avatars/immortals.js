...
class Immortals_C {
    ...
    drow() {
        ...
        for (let i = 1; i < this.List.length; i++) {
            ...
            this.out_html5Sprites_R.drowSprite(this.List[i].type, this.List[i].index, this.List[i].imageLeft, this.List[i].imageTop);
            this.out_html5Canvas_R.drawRect(this.List[i].imageLeft, this.List[i].imageTop, this.List[i].imageWidth, this.List[i].imageHeight, this.out_html5Canvas_R.LINE_WIDTH_1, this.out_html5Canvas_R.BLUE, 0);
            this.out_html5Canvas_R.drawText("point_angle = " + this.List[i].point_view_angle, this.List[i].imageLeft, this.List[i].imageTop - 70, this.out_html5Canvas_R.ITALIC_15PT_ARIAL, this.out_html5Canvas_R.BLUE, 1);
            this.out_html5Canvas_R.drawText("x = " + this.List[i].imageLeft, this.List[i].imageLeft, this.List[i].imageTop - 40, this.out_html5Canvas_R.ITALIC_15PT_ARIAL, this.out_html5Canvas_R.BLUE, 1);
            this.out_html5Canvas_R.drawText("y = " + this.List[i].imageTop, this.List[i].imageLeft + 80, this.List[i].imageTop - 40, this.out_html5Canvas_R.ITALIC_15PT_ARIAL, this.out_html5Canvas_R.BLUE, 1);
            this.out_html5Canvas_R.drawText(this.out_html5Sprites_R.out_html5SpritesCollection_R.getSpriteString(this.List[i].type, this.List[i].index), this.List[i].imageLeft, this.List[i].imageTop - 15, this.out_html5Canvas_R.ITALIC_15PT_ARIAL, this.out_html5Canvas_R.BLUE, 1);
            this.out_html5Canvas_R.drawCreaturesCircle(this.List[i].pointLeft, this.List[i].pointTop, this.List[i].pointViewRadius, this.List[i].pointViewAngle, this.out_html5Canvas_R.LINE_WIDTH_1, this.out_html5Canvas_R.RED);
