    ...
    drow() {
        for (let y = 0; y < this.Map_2d.length; y++) {
            for (let x = 0; x < this.MAP_TILE_COUNT_WIDTH; x++) {
                ...
                x * this.Map_2d[y][x].widthTile, y * this.Map_2d[y][x].heightTile, html5Canvas_R.ITALIC_15PT_ARIAL, html5Canvas_R.GREEN, 1);
                html5Canvas_R.drawRect(x * this.Map_2d[y][x].widthTile, y * this.Map_2d[y][x].heightTile, this.Map_2d[y][x].widthTile, this.Map_2d[y][x].heightTile, 1, html5Canvas_R.BLUE, 0);
            }
        }
    }
    //=============================================================================
