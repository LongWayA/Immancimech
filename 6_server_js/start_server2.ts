...
//=============================================================================
let request_url = async function (_root: string, _request: any, _response: any) {
	...
	try {
		...
		if (_request.url === '/') request_url = '/Immancimech.html';
...
//=============================================================================
let request_url_body = async function (_request: any, _response: any) {
...
//=============================================================================
http.createServer(async (_request: any, _response: any) => {
