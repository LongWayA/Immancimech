...
let root = 'G:/1_2_Andrey_programming_All/localhost/ImmortalsAndUndergroundModule/';
...
var request_url = async function (_root, _request, _response) {
	...
	try {
		...
		if (_request.url === '/') request_url = '/ImmortalsAndUnderground.html';
...
http.createServer(async (request, response) => {
	...
	if (request.url == "/user") {
		...
		request_url(root, request, response);
	};



}).listen(80, "127.0.0.1", function () { // }).listen(3000,"127.0.0.1",function(){
	global.console.log("Server listen to port 3000");
});
//=============================================================================
