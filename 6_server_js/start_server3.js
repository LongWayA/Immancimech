...
import { ai_R } from '../2_js/ai/ai.js';
console.log('ai_R.NAME = ' + ai_R.NAME);
...
let requestUrl = async function (root, request, response) {
    ...
    try {
        ...
        /////////////////////////////////
        let text = await fs.promises.readFile(root + request_url, cod);
        ...
        console.log("_request.url = " + request.url); // TypeError: failed to fetch
    } //try {
}; // var request_url
//=============================================================================
